...
instance QueryParam Param where
  ...
  qp (ByTeamMemberId team_member_id)     = tuple "team_member_id" (T.pack $ show team_member_id)
  qp (ByTeamMembersIds team_members_ids) = tuple "team_members_ids" (T.pack $ show team_members_ids)
  qp (ByGlobalGroupId gg_id)             = tuple "global_group_id" (T.pack $ show gg_id)
  qp (ByGlobalGroupsIds gg_ids)          = tuple "global_groups_ids" (T.pack $ show gg_ids)
  qp (ByGroupId g_id)                    = tuple "group_id" (T.pack $ show g_id)
  qp (ByGroupsIds g_ids)                 = tuple "groups_ids" (T.pack $ show g_ids)
  qp (ByGroupMemberId gm_id)             = tuple "group_member_id" (T.pack $ show gm_id)
  qp (ByGroupMembersIds gm_ids)          = tuple "group_members_ids" (T.pack $ show gm_ids)
...
instance Show ParamTag where
  ...
  show ParamTag_ByTeamMembersIds       = "team_members_ids"
  ...
  show ParamTag_ByGroupMembersIds      = "group_members_ids"
